package br.com.stimuli.loading.loadingtypes {
	...
	public class LanguageItem extends LoadingItem {
		public var loader:URLLoader;
		
		public var localization:GLanguage;

		public function LanguageItem(url:URLRequest, type:String, uid:String) {
			super(url, type, uid);
		}
		...
		override public function onCompleteHandler(evt:Event):void {
			try {
				//decoder "*.properties" file
//				_content = JSON.decode(loader.data);
				GMain.instance.language.register(loader.data);
			} catch (e:Error) {
				_content = null;
				status = STATUS_ERROR;
