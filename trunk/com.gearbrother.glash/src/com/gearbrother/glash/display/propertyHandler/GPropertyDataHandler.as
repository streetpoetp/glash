package com.gearbrother.glash.display.propertyHandler {
	 ...
	 */
	public class GPropertyDataHandler extends GPropertyHandler {
		...
		public function GPropertyDataHandler(updateCall:Function, propertyOwner:DisplayObject, isValidateLater:Boolean = true) {
