package com.gearbrother.glash.display {
	...
	public class GDisplayBitmap extends Bitmap implements IGDisplay {
		...
		private var _dataHandler:GPropertyDataHandler;
		public function get data():* {
			return _dataHandler ? _dataHandler.value : null;
		}
		public function set data(newValue:*):void {
			_dataHandler ||= new GPropertyDataHandler(handleModelChanged, this);
			_dataHandler.value = newValue;
		}
